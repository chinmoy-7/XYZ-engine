...
export const MainForm = () => {
  ...
  return (
    <div>
      <Grid container flexDirection={"column"} sx={{background: "linear-gradient(112.1deg, rgb(32, 38, 57) 11.4%, rgb(63, 76, 119) 70.2%)"}} display={"flex"} justifyContent={"center"} bgcolor={"black"} alignItems={"center"} height={"100vh"}>
